...
本項目由 By Chico 漢化，嚴禁販賣！項目地址:https://github.com/Chico890921/TW_Sqlmap
...
LEGAL_DISCLAIMER = "使用 sqlmap 攻擊目標而沒有事先得到雙方的共識是違法的。最終用戶有責任遵守所有適用的地方、州和聯邦法律。開發者不承擔任何責任,也不對該程序的任何濫用或造成的任何損害負責。"
